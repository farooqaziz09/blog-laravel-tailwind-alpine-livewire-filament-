<button wire.loading.attr="disabled" class="flex items-center" wire:click="toggleLike()">
  <svg wire:loading.delay aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-red-200 animate-spin dark:text-gray-600"
